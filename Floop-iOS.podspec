Pod::Spec.new do |s|
  ...
  s.frameworks =  'AdSupport', 'CFNetwork', 'CoreData', 'CoreImage', 'MobileCoreServices', 'SystemConfiguration', 'QuartzCore', 'Social', 'MessageUI', 'CoreMedia', 'CoreVideo', 'OpenGLES', 'AVFoundation'
